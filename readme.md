...
> Serverless Devs 应用开发需要严格遵守 [Serverless Package Model](../../spec/zh/0.0.2/serverless_package_model/readme.md) 中的 [插件模型规范](../../spec/zh/0.0.2/serverless_package_model/3.package_model.md#插件模型规范)。在[插件模型规范](../../spec/zh/0.0.2/serverless_package_model/3.package_model.md#插件模型规范)中有关于[插件模型元数据](../../spec/zh/0.0.2/serverless_package_model/3.package_model.md#插件模型元数据)的说明。
